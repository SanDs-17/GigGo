  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--border)', background: 'var(--surface)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          <div>
            ...
            <input className="input" defaultValue={user?.name || 'Midnight Echo'} />
          </div>
          <div>
            <label style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--text-2)', display: 'block', marginBottom: '0.375rem' }}>Email</label>
            <input className="input" type="email" defaultValue={user?.email || 'midnight@echo.com'} />
          </div>
        </div>
        <button className="btn-primary" style={{ marginTop: '1.25rem', fontSize: '0.85rem' }}>Save changes</button>
      </div>
      ...
      <div style={{ padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--border)', background: 'var(--surface)' }}>
        ...
        <button className="btn-secondary" style={{ marginTop: '1.25rem', fontSize: '0.85rem' }}>Update bank details</button>
      </div>
